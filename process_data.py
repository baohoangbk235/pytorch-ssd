...
def main():
    ...
    out_class_names_file = osp.join(args.output_dir, "labels.txt")
    with open(out_class_names_file, "w") as f:
        f.writelines("\n".join(class_names))
    print("Saved class_names:", out_class_names_file)

    if not os.path.exists(osp.join(args.output_dir, "ImageSets/Main")):
        os.makedirs(osp.join(args.output_dir, "ImageSets/Main"))

    with open(osp.join(args.output_dir, "ImageSets/Main/trainval.txt"), 'w') as f_write:
